...
var comment = JSON.parse(localStorage.getItem('inputs'));
console.log(comment.firstName);
console.log("ONE")
var dataSource = [
  {name: comment.firstName,  jobprofile: 'ICS_IMPACT'},
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log(comment.firstName);
    document.getElementById("name").innerText=comment.firstName;
document.getElementById("email").innerText=comment.email;
document.getElementById("dob").innerText=comment.dob;
document.getElementById("experience").innerText=comment.experience;
});
