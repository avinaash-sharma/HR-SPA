...
window.self.actionCellRendered = function () { };
window.self.actionCellRenders = function () { };
...
//     // }
// }
window.self.actionCellRendered.prototype = {
    init: function (params) {
        this.actionsButton = document.createElement('div');
        this.actionsButton.innerHTML = `
<div class="btn-group "  >
...
window.self.actionCellRenders.prototype = {
    init: function (params) {
        this.actionsButton = document.createElement('div');
        this.actionsButton.innerHTML = `
